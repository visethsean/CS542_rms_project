...
<head>
    ...
    <style> /* set the CSS for graph d3*/
...
<div class="navbar-default sidebar" role="navigation">
    ...
    */
    //d3.json("http://localhost/d3/report_reservation.php", function(error, data) {
    d3.json("<?php echo $this->config->base_url() ?>/d3/report_reservation.php", function(error, data) {
        data.forEach(function(d) {
            d.date = parseDate(d.date);
            d.close = +d.close;
        });
